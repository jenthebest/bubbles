...
//compute the best solutions and display results
bestSolutions = getBestResults(scores, highScore);
console.log("Solutions with highest score: " + bestSolutions);

// compute the most cost effective of the best solutions and display results
...
function printAndGetHighScore(scores) {
	...
	// loop through scores array and list scores
